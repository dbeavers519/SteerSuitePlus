...
namespace SteerLib {
	...
	public:
		...
		/// Adds an agent to a waiting list
		virtual void addWaitingAgent(const SteerLib::AgentInitialConditions & initialConditions, SteerLib::ModuleInterface * owner) = 0;
		/// Checks the list of waiting agents for ready agents
		virtual void checkWaitingAgents() = 0;
